...
v1.0.1은 v1.0.0 테스트 중 발견한 작은 문제와 UI/UX를 정리하는 안정화 패치다.
...
- [x] `README.md`를 `docs/README_v1_0_1.md`로 복사
- [x] `README.md`를 v1.1.0 진행판으로 전환
- [x] `README_CODEX.md` 현재 구현 상태 업데이트

---

## 다음 버전: v1.1.0

v1.1.0에서는 `/brainstorm` 페이지를 추가하는 방향으로 진행한다.
...
v1.1.0 계획 상세는 [README_v1_1_0.md](README_v1_1_0.md)를 참고한다.
