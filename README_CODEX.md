...
현재 루트 `README.md`는 v1.1.1 진행판이다. v1.1.0 완료 상태는 `docs/README_v1_1_0.md`에서 확인한다.
...
따라서 현재 루트 `README.md`는 v1.1.2 진행판이다. v1.1.2는 아직 포함 작업이 확정되지 않았고, v1.1.1 이후 남은 개발 후보 중 다음에 진행할 작은 범위를 고르는 단계다.
